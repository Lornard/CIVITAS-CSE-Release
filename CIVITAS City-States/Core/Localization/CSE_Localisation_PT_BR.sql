...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_TRADE_TRAIT_LARGEST_INFLUENCE_BONUS_ALT",		"+4 de [ICON_GOLD] Ouro em cada edificação de Stock Exchange."					),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_MEDIUM_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé em cada edificação de Shrine."					),
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_LARGE_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé em cada edificação de Temple."					),
	("pt_BR",	"LOC_CSE_RELIGIOUS_TRAIT_LARGEST_INFLUENCE_BONUS",		"+2 de [ICON_FAITH] Fé em cada edificação de Worship building."			),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_ALAMUT_CHAPTER_HISTORY_PARA_1",	"Alamut (meaning 'eagle's nest') was a mountain fortress located in Alamut region in the South Caspian province of Daylam near the Rudbar region in Persia, approximately 100 km (60 mi) from present-day Tehran. In 1090 AD, Alamut Castle was seized as a mountain fortress, and until 1256, under the leadership of Hasan-i Sabbah, Alamut became the site of intense activity for the Shi'a Nizari Ismai'lis, functioning as the headquarters of their state, which consisted of a series of unconnected strategic strongholds scattered throughout Persia and Syria, surrounded by the Seljuq Empire."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_AZCAPOTZALCO_CHAPTER_HISTORY_PARA_1",	"Azcapotzalco was a pre-Columbian Nahua altepetl (city-state), capital of the Tepanec empire, in the Valley of Mexico, on the western shore of Lake Texcoco."	),
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_AZCAPOTZALCO_CHAPTER_HISTORY_PARA_2",	"Azcapotzalco was founded in the 13th century in the west of Lake Texcoco. Azcapotzalco maintained a dominant hegemony with the Aztecs, who arrived in 1299, settling on the Chapultepec Hill."	),
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_AZCAPOTZALCO_CHAPTER_HISTORY_PARA_3",	"Around of 1315, the Tepanec, Toltec and Chichimec drove the Aztecs definitively from Chapultepec. Cópil was captured and killed by the Aztecs. His heart was ripped out and thrown into the River. According to a legend, Huitzilopochtli had to kill his nephew, Cópil and threw his heart in the Lake. However, since Cópil was his relative, Huitzilopochtli decided to honor him and made a cactus grow over Cópil heart and it became a sacred place."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_BAIAE_CHAPTER_HISTORY_PARA_3",	"The lower part of the town later became submerged in the sea due to local volcanic, bradyseismic activity which raised or lowered the land, and recent underwater archaeology has revealed many of the fine buildings now protected in the submerged archaeological park."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_BUTUAN_CHAPTER_HISTORY_PARA_5",	"By the late 1940s to the 1970s, Butuan's industry specialized in timber, earning it the nickname, 'Timber City of the South'. The plentiful trees of the area invited many investors to the city, and inspired then-congressman Marcos M. Calo to file a bill elevating Butuan for cityhood. On August 2, 1950, this was passed converting Butuan into a city."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_CHAN_CHAN_CHAPTER_HISTORY_PARA_1",	"Chan Chan was the largest pre-Columbian era city in South America. It is now an archaeological site west of Trujillo, Peru."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_DAKAR_CHAPTER_HISTORY_PARA_1",	"The area that is now Dakar was first settled around the 15th century. In 1444, Portuguese created a colony there. By 1536, the colony was being used to as part of the slave trade. Between 1588 and 1677, the area was fought over by many countries. During this time it was under the control of the Portuguese, Dutch, English, and finally the French."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_DODONA_CHAPTER_HISTORY_PARA_2",	"The priestesses and priests of Dodona in the sacred grove interpreted the rustling of the oak (or beech) leaves to determine the correct actions to be taken. The oracular sound may have originated from bronze objects hanging from oak branches and sounded with the wind blowing, similar to a wind chime. This is in stark contrast to the method of the Pythia at Delphi, who inhaled intoxicating fumes emanating from a fissure in the earth."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_GUNDESHAPUR_CHAPTER_HISTORY_PARA_1",	"Gundeshapur was the intellectual centre of the Sassanid Empire and the home of the Academy of Gundishapur, founded by Sassanid king Shapur I. Gundeshapur was home to a teaching hospital and had a library and a centre of higher learning. It has been identified with extensive ruins south of Shahabad, a village 14 km south-east of Dezful, to the road for Shushtar, in the present-day province of Khuzestan, southwest Iran."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_HADAD_CHAPTER_HISTORY_PARA_1",	"Hadad, now known as Aleppo, has been occupied for approximately 7000 years. The first record of Aleppo comes from the third millennium BC, when Aleppo was the capital of an independent kingdom closely related to Ebla, known as Armi to Ebla and Arman to the Akkadians. In the Old Babylonian period, Aleppo's name appears as Halab (Halba) for the first time. Aleppo was the capital of the important Amorite dynasty of Yamhad. The kingdom of Yamhad (ca. 1800-1600 BC), alternatively known as the 'land of Halab,' was the most powerful in the Near East at the time."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_PEDIA_CITYSTATES_PAGE_CIVILIZATION_CSE_HALIN_CHAPTER_HISTORY_PARA_3",	"The city came under attack from warriors invading from the Nanzhao Kingdom, and the city was destroyed in 832 AD."	),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CIVILIZATION_CSE_HORMUZ_NAME",			"Hormuz"		),
...
-----------------------------------------------
	...
	("pt_BR",	"LOC_CIVILIZATION_CSE_JOHANNESBURG_NAME",			"Johannesburg"	),
